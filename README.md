...
## Notes
The script works on QIIME2-exported feature and taxonomy tables.
Taxa are filtered before plotting to improve biological interpretability.
The resulting diagrams are intended for descriptive and comparative analysis of core microbiome overlap.
